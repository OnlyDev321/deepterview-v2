...
const PositionDropdown = ({ categories, value, onSelect }: PositionDropdownProps) => {
  ...
  const hoveredDepartment = categories.find((d) => d.id === hoveredDept);
        ...
        {isOpen && (
          ...
          >
            <div className="flex">
              <div className="w-[200px] py-2">
                {categories.map((dept) => (
                  <div
                    ...
                    onClick={() => {
                      if (dept.children.length > 0 && !hoveredDept) {
                        handleDeptMouseEnter(dept.id);
                      }
                    }}
              ...
              <AnimatePresence>
                {hoveredDepartment && hoveredDepartment.children.length > 0 && (
                  <motion.div
                  ...
                  >
                    <div className="w-[200px] py-2">
                      {hoveredDepartment.children.map((child) => (
                        <div
                          key={child.id}
